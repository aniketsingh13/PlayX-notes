    ...
    <div className="Signup-container flex flex-center mt-l">
        <form className="Signup-form  pt-l mb-s" onSubmit={signupHandler}>
            ...
            <div className=" mt-l ">
                ...
                <input type="text" className="f-s mt-s " name="firstName" id="firstName" placeholder="Enter your firstName"
                value={firstName}
            ...
            <div className=" mt-l ">
                ...
                <input type="text" className="f-s mt-s " name="lastName" id="lastName" placeholder="Enter your LastName"
                value={lastName}
            ...
            <div className="mt-l">
                ...
                <input type={showPass ? "text" : "password"} className="f-s  mt-s " name="password" id="password" placeholder="Enter your password" 
                value={password}
            ...
            <div className="mt-l">
                <label  className="Signup-email-label font-s">Confirm Password</label>
                <input type={showPass ? "text" : "password"} className="f-s  mt-s " name="confirpass" id="confirmpass" placeholder="Enter your password again"
                value={confirmPassword}
                onChange={(e) => dispatch({type: "CONFPASS",payload: e.target.value})}
                required
                />
            </div>
            <div className='mt-s'>
            ...
            <div className="mt-s flex">
                <input type="checkbox" id="Show" name="Show" className="Signup-checkbox" 
                  value={showPass}
            ...
            <div className="mt-l">
                <button className="Signup-btn f-s" type='submit'>Create New Account</button>
            </div>
            <div className="mt-s mb-l">
               <Link to='/login' className='f-s font-l' >Already have an account</Link>
            </div>
        </form>
    </div>
    </div>
